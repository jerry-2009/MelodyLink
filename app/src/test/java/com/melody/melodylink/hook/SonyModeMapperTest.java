...
public class SonyModeMapperTest {
    @Test public void mapsMelodyNoiseIndicesToSonyModes() {
        ...
        assertEquals(SonyAncMode.NOISE_CANCELING, SonyModeMapper.fromMelodyIndex(1));
        assertEquals(SonyAncMode.AMBIENT_SOUND, SonyModeMapper.fromMelodyIndex(2));
        ...
        assertEquals(2, SonyModeMapper.toMelodyIndex(SonyAncMode.AMBIENT_SOUND));
        assertEquals(1, SonyModeMapper.toMelodyIndex(SonyAncMode.NOISE_CANCELING));
    }
}
