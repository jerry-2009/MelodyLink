...
/** Maps Melody's target-panel ANC indices to the WF-1000XM3 mode set. */
public final class SonyModeMapper {
    ...
    public static SonyAncMode fromMelodyIndex(int modeIndex) {
        switch (modeIndex) {
            ...
            case 1: return SonyAncMode.NOISE_CANCELING;
            case 2: return SonyAncMode.AMBIENT_SOUND;
            case 3:
    ...
    public static int toMelodyIndex(SonyAncMode mode) {
        ...
        switch (mode) {
            case OFF: return 0;
            case AMBIENT_SOUND: return 2;
            case NOISE_CANCELING: return 1;
